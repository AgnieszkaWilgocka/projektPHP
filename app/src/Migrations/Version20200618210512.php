 ...
 */
final class Version20200618210512 extends AbstractMigration
{
    /**
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE users_data_id users_data_id INT DEFAULT NULL, CHANGE roles roles JSON NOT NULL');
    }
